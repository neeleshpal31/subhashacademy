-- SQLite initialization script for the college website
...
INSERT OR IGNORE INTO admissions (id, name, email, phone, course, message)
VALUES (1, 'DBTest_20260312191103', 'dbtest@example.com', '9999999999', 'BCA', 'Database test entry');

INSERT OR IGNORE INTO gallery_images (id, title, description, filename, created_at, category)
